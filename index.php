...
<body>
        ...
        <div class="container">
            <div class="banner-wrapper">
                <div class="banner-left">
                    ...
                    <p>Find your favourite delicious hot food!</p>
                        ...
                        <form method="post" name="search" action="search-food.php">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" id="exampleInputAmount" name="searchdata"
                                    id="searchdata" placeholder="I would like to eat....">
                            </div>
    ...
    <div class="location-match">
        <div class="container"> <span>Popular Delicious Foods Here: <span class="primary-color">All over India<span>
    ...
    <section class="popular">
        <div class="container">
            ...
            <div class="section-head">
                <h2 class="section-title">Popular This Month In Your City</h2>
